# Generated by Django 5.0 on 2024-12-20 12:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('LEARNER', 'Learner'), ('SKILL_SHARER', 'Skill Sharer')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookings_as_learner', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
